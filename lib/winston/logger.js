...
Logger.prototype.log = function (level) {
  var self = this,
      ...
      // [HACK] jlukanta : We remove meta because it causes the error log to be printed differently from console.log
...
Logger.prototype._uncaughtException = function (err) {
  ...
  function logAndWait(transport, next) {
    if (err instanceof Error) {
      ...
      transport.logException('uncaughtException: ' + err, info, next, err);
    }
  }
